...
import { students, classAverageFeatures } from "@/data/mockData";
import { ArrowUp, ArrowDown, Minus, ExternalLink, Github } from "lucide-react";
...
export default function StudentProfile({ onRoleSwitch }: StudentProfileProps) {
  ...
  if (!student) {
    return (
      <AppLayout role="instructor" onRoleSwitch={onRoleSwitch} breadcrumbs={[{ label: "Dashboard", href: "/instructor" }, { label: "Not Found" }]}>
      ...
      <div className="space-y-6 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-4">
          <RiskTrendChart
            ...
            subtitle={`${student.name}'s risk progression over 12 weeks`}
          />
          <FeatureRadarChart
        ...
        <div className="rounded-xl border border-border bg-card p-5">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {featureKeys.map((key) => {
              ...
              const studentVal = student.features[key];
              const avgVal = classAverageFeatures[key as keyof typeof classAverageFeatures];
              ...
              return (
                <div key={key} className="flex items-center justify-between rounded-lg bg-muted/40 px-3 py-2.5">
                  ...
                  <div className="flex flex-col items-end gap-0.5">
                    <CompareArrow studentVal={studentVal as number} avgVal={avgVal as number} higherIsBetter={meta.higherIsBetter} />
